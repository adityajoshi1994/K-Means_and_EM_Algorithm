...
def gaussian_mixture(data, Km, init_method, epsilon, niterations, plotflag,r, RSEED=123):
...
if __name__ == "__main__":
    ...
    data1 = pd.read_csv("/Users/adityajoshi/UCI/Quarter 2/Probabilistic Learning/dataset3.csv",
    ...
    ll,Ks = gaussian_mixture(data,6,0,0.1,2000,0,1)
    #plotLikelihood(lls)
